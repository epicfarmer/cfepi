...
namespace detail {
  ...
  0, \"compartment\": \"R\"} ],	    \"comment_rate\": \"1 / 2.25 = 0.4444444444444444\",
  \"rate\": 0.4444444444444444	},	{	    \"source\": [ [ \"I\" ], [ \"S\", \"V\" ] ],
  \"destination\": [ {\"index\": 1, \"compartment\": \"I\"} ],	    \"comment_rate\": \"1.75 * 1
  / 2.25 / 400000 = 0.000001944444\",	    \"rate\": 0.000001944444	}    ],
  \"initial_conditions\": {	\"S\": 399995,	\"I\": 5    },    \"worlds\": [	{
  ...
  \"parameters\" : {		    \"event_index\": 1,		    \"reduction_percentage\": 0.05,
  \"compartment_to_filter\": \"S\",		    \"index_to_filter\": 1		}	    },
  \"state_modifier\": {\"function\": \"do_nothing\"},	    \"state_filter\": {\"function\":
  \"do_nothing\"}	},	{	    \"event_filter\": {		\"function\":
  \"flat_reduction_single_compartment\",		\"parameters\" : {
  \"event_index\": 1,		    \"reduction_percentage\": 1.0,
  ...
  \"state_filter\": {\"function\": \"do_nothing\"}	}    ]}"; constexpr auto states_size =
  ...
  event_sizes>::any_event_type any_config_event_type; typedef
...
int main(int argc [[maybe_unused]], char **argv [[maybe_unused]]) {
  /*
    ...
    auto simulation =
      cfepi::run_simulation<decltype(states), any_config_event_type,
    any_config_event>(event_type_tuple, initial_conditions, std::array<double, 2>({ .1, 2. /
